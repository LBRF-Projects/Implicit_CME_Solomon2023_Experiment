...
# this needs to be a multiple of 15 if i have 3 speeds and 3 different figs at 2 2 1 ratio
trials_per_block = 30
...
experiment_complete_message = "Thanks for participating, you're all finished! Please alert your experimenter for debriefing!"
intertrial_rest_interval = 10  # seconds
...
# Practice Controls
########################################
# turn off (i.e. 'false') the first one if running klibs 13 from laptop
