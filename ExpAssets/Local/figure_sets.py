...
fig_set_1 = FigureSet("end")
fig_set_1.add_figures("heart")

fig_set_2 = FigureSet("test1")
fig_set_2.add_figures("heart", "template_1477106073.55")
...
fig_set_5 = FigureSet("set1")
fig_set_5.add_figures(("random", 2), ("template_1477111169.26", 2), ("template_1477081781.44", 1))

fig_set_6 = FigureSet("set2")
fig_set_6.add_figures(("random", 2), ("template_1477121315.85", 2), ("template_1477090164.31", 1))

fig_set_7 = FigureSet("set3")
fig_set_7.add_figures(("random", 2), ("template_1477090164.31", 2), ("template_1477111169.26", 1))

fig_set_8 = FigureSet("set4")
fig_set_8.add_figures(("random", 2), ("template_1477081781.44", 2), ("template_1477121315.85", 1))

fig_set_9 = FigureSet("set5")
fig_set_9.add_figures(("random", 2), ("template_1477081781.44", 2), ("template_1477090164.31", 1))
