...
fig_set_5.add_figures("random", "template_1477106073.55")

fig_set_6 = FigureSet("set2")
fig_set_6.add_figures(("random", 2), ("template_1477106073.55", 2), ("template_1477090164.44", 1))

fig_set_7 = FigureSet("set3")
fig_set_7.add_figures("template_1477106073.55", "template_1477081781.44")


fig_set_8 = FigureSet("set4")
fig_set_8.add_figures("heart")
